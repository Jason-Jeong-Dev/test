...
function TOC({ headings, filePath }) {
  ...
  return /* @__PURE__ */ jsxs16(
    "div",
    {
      ...
      children: [
        hasHeadings && /* @__PURE__ */ jsxs16(Fragment9, { children: [
          /* @__PURE__ */ jsx24("p", { className: "nx-mb-4 nx-font-semibold nx-tracking-tight", children: renderComponent(config.toc.title) }),
          /* @__PURE__ */ jsx24("ul", { children: items.map(({ id, value, depth }) => {
            var _a2, _b, _c, _d;
            return /* @__PURE__ */ jsx24("li", { className: "nx-my-2 nx-scroll-my-6 nx-scroll-py-6", children: /* @__PURE__ */ jsx24(
              "a",
              {
                href: `#${id}`,
                className: cn14(
        ...
        hasMetaInfo && /* @__PURE__ */ jsxs16(
          "div",
          {
            ...
            children: [
              config.feedback.content ? /* @__PURE__ */ jsx24(
                Anchor,
                {
    ...
    () => (
      ...
      search ? matchSorter(directories, search, { keys: ["title"] }).map(
        ({ route, title }) => ({
          id: route + title,
          route,
          children: /* @__PURE__ */ jsx25(HighlightMatches, { value: title, match: search })
        })
      ) : []
    ),
    [search, directories]
...
var DEFAULT_THEME = {
  ...
  chat: {
    icon: /* @__PURE__ */ jsxs17(Fragment10, { children: [
      /* @__PURE__ */ jsx26(DiscordIcon, {}),
      /* @__PURE__ */ jsx26("span", { className: "nx-sr-only", children: "Discord" })
    ] })
  },
  darkMode: true,
  direction: "ltr",
  ...
  editLink: {
    component: function EditLink({ className, filePath, children }) {
      ...
      return /* @__PURE__ */ jsx26(Anchor, { className, href: editUrl, children });
    },
    text: "Edit this page"
  },
  feedback: {
  ...
  gitTimestamp: function GitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ jsxs17(Fragment10, { children: [
      "Last updated on",
      " ",
      /* @__PURE__ */ jsx26("time", { dateTime: timestamp.toISOString(), children: timestamp.toLocaleDateString(locale, {
        day: "numeric",
        month: "long",
        year: "numeric"
      }) })
  ...
  head: /* @__PURE__ */ jsxs17(Fragment10, { children: [
    /* @__PURE__ */ jsx26("meta", { name: "msapplication-TileColor", content: "#fff" }),
    /* @__PURE__ */ jsx26("meta", { httpEquiv: "Content-Language", content: "en" }),
    /* @__PURE__ */ jsx26("meta", { name: "description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx26("meta", { name: "twitter:card", content: "summary_large_image" }),
    /* @__PURE__ */ jsx26("meta", { name: "twitter:site", content: "@shuding_" }),
    /* @__PURE__ */ jsx26("meta", { property: "og:title", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx26("meta", { property: "og:description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx26("meta", { name: "apple-mobile-web-app-title", content: "Nextra" })
  ] }),
  i18n: [],
  logo: /* @__PURE__ */ jsxs17(Fragment10, { children: [
    /* @__PURE__ */ jsx26("span", { className: "nx-font-extrabold", children: "Nextra" }),
    /* @__PURE__ */ jsx26("span", { className: "nx-ml-2 nx-hidden nx-font-normal nx-text-gray-600 md:nx-inline", children: "The Next Docs Builder" })
  ] }),
  logoLink: true,
  navbar: {
    component: Navbar
  ...
  project: {
    icon: /* @__PURE__ */ jsxs17(Fragment10, { children: [
      /* @__PURE__ */ jsx26(GitHubIcon, {}),
      /* @__PURE__ */ jsx26("span", { className: "nx-sr-only", children: "GitHub" })
    ] })
  },
  search: {
    component: function Search2({ className, directories }) {
      const config = useConfig();
      return config.flexsearch ? /* @__PURE__ */ jsx26(Flexsearch, { className }) : /* @__PURE__ */ jsx26(MatchSorterSearch, { className, directories });
    },
    emptyResult: /* @__PURE__ */ jsx26("span", { className: "nx-block nx-select-none nx-p-8 nx-text-center nx-text-sm nx-text-gray-400", children: "No results found." }),
  ...
  sidebar: {
    ...
    titleComponent: ({ title }) => /* @__PURE__ */ jsx26(Fragment10, { children: title }),
    toggleButton: false
  },
  themeSwitch: {
...
import { Children, cloneElement, useEffect as useEffect5, useRef as useRef7, useState as useState7 } from "react";
...
function HeadingLink(_a) {
  ...
  return /* @__PURE__ */ jsxs18(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        children,
        /* @__PURE__ */ jsx27("span", { className: "nx-absolute -nx-mt-20", id, ref: obRef }),
        /* @__PURE__ */ jsx27(
          "a",
          {
            href: `#${id}`,
...
var Details = (_a) => {
  ...
  return /* @__PURE__ */ jsxs18(
    ...
    __spreadProps(__spreadValues(__spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx27(DetailsProvider, { value: setOpen, children: summary }),
        /* @__PURE__ */ jsx27(Collapse, { isOpen: openState, children: restChildren })
      ]
    })
  );
};
...
var A = (_a) => {
  ...
  return /* @__PURE__ */ jsx27(Anchor, __spreadValues({ href, newWindow: EXTERNAL_HREF_REGEX.test(href) }, props));
};
var getComponents = ({
  isRawLayout,
  components
  ...
  return __spreadValues({
    h1: (props) => /* @__PURE__ */ jsx27(
      "h1",
      __spreadValues({
        className: "nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100"
      }, props)
    ),
    h2: (props) => /* @__PURE__ */ jsx27(HeadingLink, __spreadValues({ tag: "h2", context }, props)),
    h3: (props) => /* @__PURE__ */ jsx27(HeadingLink, __spreadValues({ tag: "h3", context }, props)),
    h4: (props) => /* @__PURE__ */ jsx27(HeadingLink, __spreadValues({ tag: "h4", context }, props)),
    h5: (props) => /* @__PURE__ */ jsx27(HeadingLink, __spreadValues({ tag: "h5", context }, props)),
    h6: (props) => /* @__PURE__ */ jsx27(HeadingLink, __spreadValues({ tag: "h6", context }, props)),
    ul: (props) => /* @__PURE__ */ jsx27(
      "ul",
      __spreadValues({
        className: "nx-mt-6 nx-list-disc first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    ol: (props) => /* @__PURE__ */ jsx27(
      "ol",
      __spreadValues({
        className: "nx-mt-6 nx-list-decimal first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    li: (props) => /* @__PURE__ */ jsx27("li", __spreadValues({ className: "nx-my-2" }, props)),
    blockquote: (props) => /* @__PURE__ */ jsx27(
      "blockquote",
      __spreadValues({
        className: cn15(
    ...
    a: Link,
    table: (props) => /* @__PURE__ */ jsx27(
      Table,
      __spreadValues({
        className: "nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0"
      }, props)
    ),
    p: (props) => /* @__PURE__ */ jsx27("p", __spreadValues({ className: "nx-mt-6 nx-leading-7 first:nx-mt-0" }, props)),
    tr: Tr,
    th: Th,
    td: Td,
    details: Details,
...
var classes4 = {
  ...
  main: cn16("nx-w-full nx-break-words")
};
var Body = ({
  themeContext,
  breadcrumb,
  ...
  if (themeContext.layout === "raw") {
    return /* @__PURE__ */ jsx28("div", { className: classes4.main, children });
  }
  const date = themeContext.timestamp && config.gitTimestamp && timestamp ? new Date(timestamp) : null;
  const gitTimestampEl = (
    // Because a user's time zone may be different from the server page
    mounted && date ? /* @__PURE__ */ jsx28("div", { className: "nx-mt-12 nx-mb-8 nx-block nx-text-xs nx-text-gray-500 ltr:nx-text-right rtl:nx-text-left dark:nx-text-gray-400", children: renderComponent(config.gitTimestamp, { timestamp: date }) }) : /* @__PURE__ */ jsx28("div", { className: "nx-mt-16" })
  );
  ...
  return /* @__PURE__ */ jsx28(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxs19("main", { className: "nx-w-full nx-min-w-0 nx-max-w-6xl nx-px-6 nx-pt-4 md:nx-px-12", children: [
        breadcrumb,
        body
      ] })
    }
...
var InnerLayout = ({
  ...
  const tocEl = activeType === "page" || !themeContext.toc || themeContext.layout !== "default" ? themeContext.layout !== "full" && themeContext.layout !== "raw" && /* @__PURE__ */ jsx28("nav", { className: classes4.toc, "aria-label": "table of contents" }) : /* @__PURE__ */ jsx28(
    "nav",
    {
      className: cn16(classes4.toc, "nx-px-4"),
  ...
  return (
    ...
    // `html` element.
    /* @__PURE__ */ jsxs19("div", { dir: direction, children: [
      /* @__PURE__ */ jsx28(
        "script",
        {
      ...
      /* @__PURE__ */ jsx28(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs19(ActiveAnchorProvider, { children: [
            /* @__PURE__ */ jsx28(
              Sidebar,
              {
                docsDirectories,
            ...
            tocEl,
            /* @__PURE__ */ jsx28(SkipNavContent, {}),
            /* @__PURE__ */ jsx28(
              Body,
              {
                themeContext,
                breadcrumb: activeType !== "page" && themeContext.breadcrumb ? /* @__PURE__ */ jsx28(Breadcrumb, { activePath }) : null,
                timestamp,
                navigation: activeType !== "page" && themeContext.pagination ? /* @__PURE__ */ jsx28(
                  NavLinks,
                  {
...
function Layout(_a) {
  ...
  return /* @__PURE__ */ jsx28(ConfigProvider, { value: context, children: /* @__PURE__ */ jsx28(InnerLayout, __spreadProps(__spreadValues({}, context.pageOpts), { children })) });
}
export {
  Bleed,
  Callout,
